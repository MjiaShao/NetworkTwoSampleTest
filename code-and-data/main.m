...
%% input
% filenamesave1: filename of file where to store hashing information of A1
% filenamesave2: filename of file where to store hashing information of A2
% conf_level: alpha
...
% conf_int: a matrix with each row representing the Confidence Interval for each Motif
